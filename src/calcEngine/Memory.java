...
public class Memory {
    ...
    * */
    ...
    public static void memoryQuerySaveResult (double memoryInput) {
        ...
        logger.trace("Entering general memory query.");
        ...
        logger.info("Default action - memory array at index 0 set to: " + memoryInput + " - as last computation value.");

        info.printCaption("mlt_obj_mem_initial_query");

        while (queryOnOff) {
            logger.info("Asking user, if he wants to store value in multiple object memory.");
    ...
    public static void memoryQueryStoreValueInArray(double memoryArrayInput) {
        ...
        while (queryOnOff) {
            logger.trace("Entering multiple memory query.");
            ...
            if (index == 1) {
                ...
                logger.error("User has chosen wrong value to point location in memory.");
    ...
    public static void memoryArrayDisplay() {
        ...
        // pętla wyświetlająca wszystkie elementy tablicy (poza pierwszym)
